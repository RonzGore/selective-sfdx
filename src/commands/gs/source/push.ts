...
const messages = core.Messages.loadMessages('selective-sfdx', 'push');

export default class Push extends SfdxCommand {
  //This static variable sets the command description for help
  public static description = messages.getMessage('pushCommandDescription');
  ...
  protected static flagsConfig = {
    ...
    modulepath: flags.string({char: 'm', required: true, description: messages.getMessage('modulePathDescription')}),
  };
